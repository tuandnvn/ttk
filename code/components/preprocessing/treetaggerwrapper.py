...
class TreeTagger (object) :
    ...
    def SetTagger(self,kargs) :
        ...
        if sys.platform == "win32" :
            # For convenience, I put the treetagger for both windows and 
            # linux in the same folder
            self.tagbindir = os.path.join(self.tagdir,"window", "bin")
