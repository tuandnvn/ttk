...
#     RELAXING_CONDITION = 10
#     relaxing_beginning_requirement = False
...
#                 if relaxing_beginning_requirement:
#                     if l_index < RELAXING_CONDITION:
#                         print tempo_string
#                         at_beginning = True
#                     else:
#                         at_beginning = False
...
#                             logger.warn(l_index)
#                             logger.warn(element.next.content)
#                             logger.warn(tempo_string)
...
#                             relaxing_beginning_requirement = False
                        if l_index == -1:
                            ...
                            doc3._add_doc_element_with_check(element)
                            """
                            After consuming a non-matching token, there should be some relax on 
                            the next token, so it doesn't need to be at the beginning of
                            tempo_string, or it would always not at_beginning
                            """
#                             relaxing_beginning_requirement = True
                            continue
                    else:
                        """
                        ...
                        doc3._add_doc_element_with_check(element)
#                         relaxing_beginning_requirement = True
#                         switch_next_tempo_string_flag = True
                        continue
...
#                 if relaxing_beginning_requirement and at_beginning:
#                     relaxing_beginning_requirement = False
#                 else:
